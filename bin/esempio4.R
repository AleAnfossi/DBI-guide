# Function to calculate Davies-Bouldin index with different intracls methods
...
set.seed(456)
initial_kmeans <- kmeans(initial_data, centers = 2,iter.max=20, nstart = 1)
...
for (i in 1:iterations) {
  ...
  kmeans_result <- kmeans(data, centers = 2,iter.max=20, nstart = 1)
  ...
  print(paste("Iteration", i, "Davies-Bouldin Index (average):", db_index$average))
  print(paste("Iteration", i, "Davies-Bouldin Index (centroid):", db_index$centroid))
...
print(paste("Initial Davies-Bouldin Index (average):", initial_db_index$average))
print(paste("Initial Davies-Bouldin Index (centroid):", initial_db_index$centroid))
